...
בלמידת מכונה טבלה כזאת נקראת **מאגר נתונים — Dataset**: כל שורה היא דוגמה שהמודל ילמד ממנה, וכל עמודה היא תכונה של הדוגמה או התשובה שרוצים לחזות. בחלק ג נטען כך טבלת גבהים של הורים וילדים ונחזה גובה, ונטען טבלת מדדים רפואיים ונחזה מחלה. כמעט כל פרויקט למידה מתחיל בטעינת טבלה, בבחירת העמודות הרלוונטיות ובסינון שורות בעייתיות, וזה בדיוק מה שנלמד בפרק הזה.
