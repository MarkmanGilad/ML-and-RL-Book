...
<a href="21-NumPy.md">→ הקודם</a>
<a class="toc-link" href="../index.md#book-toc">תוכן העניינים</a>
<a href="23-%D7%AA%D7%9E%D7%95%D7%A0%D7%95%D7%AA%20%D7%9B%D7%9E%D7%A2%D7%A8%D7%9B%D7%99%D7%9D.md">הבא ←</a>
</nav>
...
<!-- editorlm-source-ref: [sources/Python/converted/4.PyPlot/notebook.md#L17-L44] -->
...
<figure>
<img src="../assets/pyplot/line-two-points.png" alt="קו כחול ישר המחבר את הנקודה (1, 2) לנקודה (3, 9)" style="max-width:100%;height:auto;">
<figcaption>קו המחבר את הנקודה (1, 2) לנקודה (3, 9).</figcaption>
</figure>
...
<!-- editorlm-source-ref: [sources/Python/converted/4.PyPlot/notebook.md#L48-L68] -->
...
<figure>
<img src="../assets/pyplot/line-marker-star.png" alt="קו אדום עם כוכב בכל נקודה, המחבר ארבע נקודות לפי סדר הנתונים" style="max-width:100%;height:auto;">
<figcaption>קו אדום המחבר ארבע נקודות לפי סדר הנתונים, עם כוכב בכל נקודה.</figcaption>
</figure>
...
הרשימה המלאה של הסימנים נמצאת [בדף הסימונים של w3schools](https://www.w3schools.com/python/matplotlib_markers.asp).
...
<figure>
<img src="../assets/pyplot/colors-markers.png" alt="שלושה קווים: אדום רציף עם כוכבים, ירוק מקווקו עם עיגולים וכחול מנוקד עם ריבועים" style="max-width:100%;height:auto;">
<figcaption>שלושה קווים על אותו תרשים, כל אחד בצבע, בסימון ובסגנון קו משלו.</figcaption>
</figure>
...
<figure>
<img src="../assets/pyplot/points-only.png" alt="ארבעה עיגולים אדומים במיקומי הנקודות, ללא קו מחבר" style="max-width:100%;height:auto;">
<figcaption>אותן ארבע נקודות, הפעם כעיגולים בלבד וללא קו.</figcaption>
</figure>
...
<figure>
<img src="../assets/pyplot/axline.png" alt="ישר אדום החוצה את כל התרשים וקטע כחול קצר יותר לצידו" style="max-width:100%;height:auto;">
<figcaption>הישר האדום נמשך עד שולי התרשים; הקטע הכחול מתחיל ונגמר בנקודות שנמסרו.</figcaption>
</figure>
...
<figure>
<img src="../assets/pyplot/scatter.png" alt="פיזור של כוכבים ורודים ועיגולים ירוקים בהירים על אותו תרשים" style="max-width:100%;height:auto;">
<figcaption>שתי קבוצות נקודות על אותו תרשים: כוכבים ורודים ועיגולים ירוקים.</figcaption>
</figure>
...
<!-- editorlm-source-ref: [sources/Python/converted/4.PyPlot/notebook.md#L175-L198] -->
...
<figure>
<img src="../assets/pyplot/settings.png" alt="שני קווים, אדום וכחול, עם כותרת, שמות לצירים, גבולות צירים ומקרא בפינה" style="max-width:100%;height:auto;">
<figcaption>שני קווים עם כותרת, שמות לצירים, גבולות ומקרא.</figcaption>
</figure>
...
<figure>
<img src="../assets/pyplot/subplot-2x2.png" alt="ארבעה תרשימים ברשת של שתי שורות ושתי עמודות" style="max-width:100%;height:auto;">
<figcaption>ארבעה תרשימים באותה מסגרת: התרשים הראשון מכיל שני קווים, והשאר קו אחד כל אחד.</figcaption>
</figure>
...
<!-- editorlm-source-ref: [sources/Python/converted/4.PyPlot/notebook.md#L250-L288] -->
...
<figure>
<img src="../assets/pyplot/subplots-grid.png" alt="מסגרת ריבועית עם ארבעה תרשימים: קו קצר, קו שבור, קו עולה ונקודות אדומות" style="max-width:100%;height:auto;">
<figcaption>המסגרת הראשונה: ארבעה תרשימים ברשת של שתיים על שתיים, ברוחב ובגובה של שבעה אינצ׳ים.</figcaption>
</figure>

<figure>
<img src="../assets/pyplot/subplots-single.png" alt="מסגרת עם תרשים יחיד: קו עם כוכבים, כותרת ושמות לצירים" style="max-width:100%;height:auto;">
<figcaption>המסגרת השנייה: תרשים יחיד עם כותרת ושמות לצירים.</figcaption>
</figure>
...
<!-- editorlm-source-ref: [sources/Python/converted/4.PyPlot/notebook.md#L298-L345] -->
...
<figure>
<img src="../assets/pyplot/function.png" alt="עקומה ירוקה של איקס בריבוע כפול קוסינוס איקס, עם תנודות הולכות וגדלות משני צידי האפס, על רקע רשת" style="max-width:100%;height:auto;">
<figcaption>הגרף של x² cos(x) בתחום שבין ‎-20 ל־20, עם רשת עזר.</figcaption>
</figure>

ככל שמתרחקים מאפס, גורם `x²` מגדיל את גובה התנודות; `grid()` מוסיפה רשת לקריאת המיקומים. ארבע מאות הנקודות צפופות מספיק כדי שהקווים הקצרים ביניהן ייראו כעקומה אחת.
...
<figure>
<img src="../assets/pyplot/bar.png" alt="ארבע עמודות תכולות בגבהים 4, 7, 1 ו-8" style="max-width:100%;height:auto;">
<figcaption>ארבע עמודות, אחת לכל קטגוריה.</figcaption>
</figure>
...
<figure>
<img src="../assets/pyplot/barh.png" alt="ארבע עמודות אופקיות ירוקות בהירות באורכים 4, 7, 1 ו-8" style="max-width:100%;height:auto;">
<figcaption>אותם נתונים בעמודות אופקיות.</figcaption>
</figure>
...
<figure>
<img src="../assets/pyplot/hist.png" alt="היסטוגרמה עם ארבעה טווחים: הטווח הראשון ריק, ואחריו עמודות בגבהים 3, 4 ו-1" style="max-width:100%;height:auto;">
<figcaption>היסטוגרמה של שמונה ערכים בארבעה טווחים ברוחב עשר.</figcaption>
</figure>
