...
<a href="10-%D7%A9%D7%95%D7%95%D7%99%D7%95%D7%9F%20%D7%95%D7%96%D7%94%D7%95%D7%AA.md">→ הקודם</a>
<a class="toc-link" href="../index.md#book-toc">תוכן העניינים</a>
<a href="12-set.md">הבא ←</a>
</nav>
...
איך המילון מוצא את `"Dana"` בלי לעבור על כל השמות? הוא מחשב מן השם עצמו מספר, שמוביל ישירות לתא שבו נשמר הזוג, כמו מספר תא בארון תאים. כך המילון נשאר מהיר גם כשיש בו אלפי שמות:
...
<figcaption>ספר טלפונים במילון: השם עובר בפונקציה שמחשבת ממנו מספר תא (החצים האדומים), ומהתא מגיעים ישירות לרשומה עם מספר הטלפון, בלי לעבור על כל השמות. על המנגנון הזה, טבלת גיבוב, ראו <a href="17-%D7%92%D7%99%D7%91%D7%95%D7%91.md">פרק א.17</a>.</figcaption>
</figure>
...
<!-- editorlm-source-ref: [sources/Python/Python_Data_Strucrures.pptx#L77-L85] -->
<!-- editorlm-source-ref: [sources/Python/converted/2.Python_Data_Struct/notebook.md#L404-L441] -->
<!-- editorlm-source-ref: [sources/Python/converted/2.Python_Data_Struct/notebook.md#L492-L567] -->
...
<!-- editorlm-source-ref: [sources/Python/converted/2.Python_Data_Struct/notebook.md#L549-L567] -->
...
<!-- editorlm-source-ref: [sources/אוניברסיטה פתוחה/converted/11-מבני נתונים מתקדמים/notebook.md#L347-L418] -->

<!-- editorlm-source-ref: [sources/אוניברסיטה פתוחה/converted/11-מבני נתונים מתקדמים/notebook.md#L673-L713] -->
