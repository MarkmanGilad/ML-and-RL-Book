...
<a href="17-%D7%92%D7%99%D7%91%D7%95%D7%91.md">→ הקודם</a>
<a class="toc-link" href="../index.md#book-toc">תוכן העניינים</a>
<a href="19-%D7%99%D7%A8%D7%95%D7%A9%D7%94.md">הבא ←</a>
</nav>
...
<!-- editorlm-source-ref: [sources/אוניברסיטה פתוחה/converted/12-תכנות מונחה עצמים/notebook.md#L1415-L1450] -->
...
הרשימה המלאה של המתודות המיוחדות מופיעה בתיעוד הרשמי של פייתון: **[Special method names](https://docs.python.org/3/reference/datamodel.html#special-method-names)**.
<!-- editorlm-source-ref: [sources/אוניברסיטה פתוחה/converted/12-תכנות מונחה עצמים/notebook.md#L340-L367] -->
<!-- editorlm-source-ref: [sources/אוניברסיטה פתוחה/converted/12-תכנות מונחה עצמים/notebook.md#L565-L605] -->
...
- **שני קווים תחתונים** בתחילת השם, כגון `__private`, מסמנים מאפיין **פרטי — Private**. פייתון משנה את שמו בתוך האובייקט ל־`_Test__private` (שם המחלקה נוסף בתחילתו), ולכן הפנייה הרגילה `ob.__private` מחוץ למחלקה נכשלת בשגיאה. הגישה עדיין אפשרית דרך השם המלא, אך אין לעשות זאת.
בדוגמה, המחלקה `Test` מגדירה מאפיין ציבורי, מאפיין מוגן ומאפיין פרטי, ומציעה מתודות לקריאה ולעדכון של הפרטי:
...
<!-- editorlm-source-ref: [sources/אוניברסיטה פתוחה/converted/12-תכנות מונחה עצמים/notebook.md#L613-L698] -->
...
<!-- editorlm-source-ref: [sources/אוניברסיטה פתוחה/converted/12-תכנות מונחה עצמים/notebook.md#L705-L727] -->
### פעולה סטטית
