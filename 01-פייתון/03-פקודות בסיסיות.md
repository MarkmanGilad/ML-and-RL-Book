...
<!-- editorlm-source-ref: [sources/Python/converted/1.Python_Basic/notebook.md#L37-L38] -->
<!-- editorlm-source-ref: [sources/Python/converted/1.Python_Basic/notebook.md#L147-L155] -->
...
פעולות באותה קדימות מתבצעות משמאל לימין, למעט שרשרת חזקות, שמקובצת מימין לשמאל. [סדר הקדימות בתיעוד Python](https://docs.python.org/3/reference/expressions.html#operator-precedence).
...
<!-- editorlm-source-ref: [sources/אוניברסיטה פתוחה/converted/1-יסודות השפה/notebook.md#L88-L90] -->
<!-- editorlm-source-ref: [sources/אוניברסיטה פתוחה/converted/1-יסודות השפה/notebook.md#L289-L292] -->
