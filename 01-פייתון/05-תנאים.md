...
לעיתים כל מה שהתנאי צריך להחליט הוא איזה ערך לשמור במשתנה — למשל איזו הודעה להציג. במקום ארבע שורות של `if`–`else` עם שתי השמות, אפשר לכתוב זאת בשורה אחת. אחרי שמבינים תנאי רגיל, אפשר לכתוב בחירה קצרה: הערך אם התנאי מתקיים, `if`, התנאי, `else` והערך האחר.
