...
**מחרוזת תיעוד (docstring)** מתארת מה הפונקציה עושה. כותבים אותה בתחילת גוף הפונקציה, בדרך כלל בתוך שלוש מירכאות. כדאי לציין את מטרת הפונקציה, את משמעות הפרמטרים ואת התוצאה שהיא מחזירה, אם יש כזו.
