...
<a href="18-%D7%A7%D7%91%D7%A6%D7%99%D7%9D.md">→ הקודם</a>
<a class="toc-link" href="../index.md#book-toc">תוכן העניינים</a>
<a href="20-NumPy%20%D7%97%D7%99%D7%A9%D7%95%D7%91%D7%99%D7%9D.md">הבא ←</a>
</nav>

## א.19 — NumPy — מערכים, צורה וחיתוך
...
הספרייה הזאת חשובה במיוחד למי שמתכוון להגיע ללמידת מכונה. בחלק ג של הספר נגלה שכל מה שרשת נוירונים עושה הוא חישובים על מערכים של מספרים: הקלט הוא מערך, המשקלים הם מערכים, ותמונה היא טבלה של מספרים. ספריית PyTorch שבה נשתמש שם עובדת עם מבנה שנקרא טנזור, שהוא למעשה מערך NumPy עם יכולות נוספות, ורוב הפעולות שנלמד כאן — צורה, חיתוך, שינוי צורה — קיימות שם באותם שמות. בפרק זה נכיר את המבנה עצמו: כיצד יוצרים מערך, מהי הצורה שלו וכיצד בוחרים ממנו חלקים. בפרק הבא נעבור לחישובים על מערכים.
