...
<a href="08-List.md">→ הקודם</a>
<a class="toc-link" href="../index.md#book-toc">תוכן העניינים</a>
<a href="10-%D7%A9%D7%95%D7%95%D7%99%D7%95%D7%9F%20%D7%95%D7%96%D7%94%D7%95%D7%AA.md">הבא ←</a>
</nav>
...
למשל, אפשר לשמור את שתי הקואורדינטות של נקודה יחד בטאפל. כך הן עוברות בתוכנית כזוג אחד; אם רוצים לייצג מיקום אחר, אפשר ליצור טאפל חדש. בפרק נשווה אותו לרשימה שכבר הכרנו.
...
**[מחברות האוניברסיטה הפתוחה — 5-רשימות](https://drive.google.com/drive/folders/1yLN-J12Mq3KZ0i6XJwpaA3XMC6xoh4GJ?usp=sharing)**
...
הפקודה `point[0] = 8` תגרום לשגיאה. אם איבר בתוך tuple הוא בעצמו רשימה, עדיין אפשר לשנות את הרשימה הפנימית.
...
<!-- editorlm-source-ref: [sources/Python/converted/2.Python_Data_Struct/notebook.md#L232-L330] -->
...
<!-- editorlm-source-ref: [sources/Python/converted/2.Python_Data_Struct/notebook.md#L280-L330] -->

### טאפל בתוך רשימה

אפשר לשמור מסלול כרשימה של נקודות, למשל `[(0, 0), (1, 2), (3, 5)]`. הרשימה מאפשרת להוסיף נקודות למסלול; כל טאפל מרכז את הקואורדינטות של נקודה אחת. זו אותה אריזה ששימשה להחזרת כמה תוצאות מפונקציה.

<!-- editorlm-source-ref: [sources/אוניברסיטה פתוחה/converted/5-רשימות/notebook.md#L583-L798] -->
