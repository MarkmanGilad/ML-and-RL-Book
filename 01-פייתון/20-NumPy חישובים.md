...
בפרק הקודם למדנו לבנות מערכים, לברר את צורתם ולבחור מהם חלקים. אבל מערך הוא רק מקום לאחסן מספרים; הכוח האמיתי של NumPy מתגלה כשמתחילים לחשב איתו. נחשוב על טבלת ציונים של כיתה: נרצה להוסיף נקודות לכולם, לחשב ממוצע לכל תלמיד ולכל מבחן, למצוא מי עבר ומי לא, ולתקן ציונים שחרגו מהטווח. את כל אלה נעשה בפרק הזה בהוראה אחת לכל פעולה, בלי לולאות.
...
זהו בדיוק סוג החישוב שבבסיס למידת המכונה. בחלק ג נראה שרשת נוירונים מקבלת מערך קלט, מכפילה אותו במטריצת משקלים, מפעילה על התוצאה פונקציה מתמטית ומחשבת ממוצע של טעויות — כל אחת מהפעולות האלה מופיעה בפרק הזה. מי שמבין כאן כיצד עובדים `broadcasting`, `axis` וכפל מטריצות, יקרא בקלות את קוד האימון בהמשך.
