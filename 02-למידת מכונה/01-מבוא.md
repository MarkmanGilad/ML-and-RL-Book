...
כשאנו משחקים מול מחשב, אנו מצפים ממנו לבחור מהלכים מועילים ולהגיב למצב המשחק. יכולות כאלה שייכות לתחום הבינה המלאכותית. למידת מכונה מאפשרת לפתח יכולות באמצעות למידה מדוגמאות ומניסיון. בפרק זה נכיר כיצד רשת של יחידות חישוב פשוטות יכולה לשמש ללמידה כזאת. <!-- editorlm-source-ref: [sources/ML/pdf/1. מבוא והתקנה.pdf#L70-L74] -->
...
**בינה מלאכותית — Artificial Intelligence, או AI — היא תחום במדעי המחשב העוסק בפיתוח מערכות המחקות יכולות של אינטליגנציה אנושית.** המטרה היא לאפשר למחשב לבצע משימות הדורשות יכולות כאלה. <!-- editorlm-source-ref: [sources/ML/pdf/1. מבוא והתקנה.pdf#L8-L11] -->
...
זיהוי התמונות ששימשו לאימון הוא רק חלק מהמשימה. אנו רוצים שהרשת תענה נכון גם על תמונה **חדשה**, שלא שימשה לאימון. היכולת להשתמש במה שנלמד מדוגמאות קודמות כדי לענות על קלט חדש נקראת **הכללה**.

בדוגמת החתולים, השאלה היא אם הרשת תזהה חתול גם בתמונה שלא פגשה. הצלחה בתמונות האימון לבדה אינה מבטיחה זאת. מטרתנו היא למצוא פונקציה שנותנת תשובה נכונה לשאלה שהגדרנו במגוון דוגמאות, ולא רק באוסף שממנו למדה. <!-- editorlm-source-ref: [sources/ML/pdf/1. מבוא והתקנה.pdf#L59-L60] --> <!-- editorlm-source-ref: [sources/ML/pdf/1. מבוא והתקנה.pdf#L64-L67] -->
