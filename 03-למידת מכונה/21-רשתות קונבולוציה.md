...
רשת CNN מעבדת אזורים קטנים בתמונה באמצעות מסננים, וכך מפיקה מידע שישמש לסיווג. פעולת החישוב הזו נקראת קונבולוציה. היא מתחילה בשכבות קונבולוציה וממשיכה ברשת נוירונים רגילה; לפני שנכיר את הפעולה, נכיר את ייצוג התמונה בזיכרון.
...
ממדי הפלט תלויים בגודל הקלט והמסנן, בריפוד ובצעד. נחשב אותם כדי לדעת מה עובר לשכבה הבאה:
...
נבחן תחילה את ייצוג התמונה לפני הוספת הנרמול. נטען תמונות באמצעות ToTensor בלבד ונדפיס תמונה אחת ואת צורתה:
...
כדי להציג את התמונות בצבעיהן הרגילים, נתאים בחזרה את הערכים ואת סדר הצירים. נגדיר פונקציה שמבצעת זאת:
