...
רשת נוירונים מלאכותית — **Artificial Neural Network, ANN** — מחברת יחידות חישוב זו לזו: תוצאות החישוב של יחידות בשכבה אחת משמשות קלט ליחידות בשכבה הבאה. נשתמש ברשת כזו כדי לזהות אם בתמונה מופיעה הספרה 7.
...
לפני האימון נבחן אצווה כדי לראות אילו תמונות ונתונים מגיעים לרשת. ניצור איטרטור ונשלוף את האצווה הראשונה:
...
נגדיר כיצד למדוד את טעות הסיווג וכיצד לעדכן את המשקלים כדי להקטין אותה.
