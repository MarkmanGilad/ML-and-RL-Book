...
<figure>
<img src="../assets/slides/b3955a4798/image5.gif" alt="המשיק נע לאורך הגרף של f(x) = x·sin(x²) + 1: ירוק כשהשיפוע חיובי, אדום כשהשיפוע שלילי, ואופקי בנקודות הקיצון." style="max-width:100%;height:auto;">
...
<figure>
<img src="../assets/autograd/graph-structure.svg" alt="גרף החישוב: x נכנס לפעולה כפל ב־4 ויוצא a, a נכנס לפעולה חיסור 1 ויוצא b, b נכנס לפעולה ריבוע ויוצא L." style="width:760px;max-width:100%;height:auto;">
...
<figure>
<img src="../assets/autograd/graph-forward.svg" alt="פעפוע קדימה: x שווה 1, כפל ב־4 נותן a שווה 4, חיסור 1 נותן b שווה 3, ריבוע נותן L שווה 9." style="width:760px;max-width:100%;height:auto;">
...
<figure>
<img src="../assets/autograd/graph-backward.svg" alt="פעפוע לאחור: מעל כל פעולה הנגזרת המקומית שלה, 4, 1 ו־6. חצים אדומים חוזרים מ־L אל x, ומתחת לכל משתנה הנגזרת המצטברת: dL/dL שווה 1, dL/db שווה 6, dL/da שווה 6, dL/dx שווה 24." style="width:760px;max-width:100%;height:auto;">
...
<figure>
<img src="../assets/autograd/graph-x2.svg" alt="אותו גרף חישוב בנקודה x שווה 2: קדימה a שווה 8, b שווה 7, L שווה 49. הנגזרות המקומיות 4, 1 ו־14. לאחור: dL/dL שווה 1, dL/db שווה 14, dL/da שווה 14, dL/dx שווה 56." style="width:760px;max-width:100%;height:auto;">
