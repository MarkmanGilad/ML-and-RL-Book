...
הנגזרת מתארת כיצד ערך הפונקציה משתנה בסביבת נקודה, ולכן יכולה להנחות אותנו בחיפוש מינימום. נלמד כללי גזירה, נגזרות חלקיות וכלל השרשרת, ולאחר מכן נראה כיצד PyTorch מחשבת נגזרות באמצעות גרף חישוב.
...
כללי גזירה מאפשרים לקבל נוסחה לנגזרת מתוך נוסחת הפונקציה.
...
כשהחישוב תלוי בכמה משתנים, נוכל לבקש נגזרת ביחס לכל אחד מהם. נחליף את הקבועים בפונקציה במשתנים ונחשב את <span dir="ltr">Loss=(wx−y)²</span>.
...
אפשר לחשב נגזרות גם כאשר מתקבלות כמה תוצאות נפרדות. כעת נשאיר את ריבועי ההפרשים כווקטור, ללא סכימה:
