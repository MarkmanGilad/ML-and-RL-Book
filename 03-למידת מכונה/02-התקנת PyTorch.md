...
אפשר להתקין את PyTorch גם על המחשב האישי ולעבוד בלי חיבור ל־Colab, אך בשלב זה אין בכך צורך. **התקנה מקומית נלמד בחלק 04 — למידת חיזוק.** עד אז נעבוד ב־Colab. בפרק הבא נכיר את הטנסורים, המבנה הבסיסי שבו PyTorch מחזיקה נתונים ומשקלים.
