...
כעת נכתוב בעצמנו את עדכון המשקל וניעזר ב־Autograd לחישוב הנגזרת. נאתחל את המשקל ל־5.5 ואת קצב הלמידה ל־0.1, ונבצע 300 איטרציות. העדכון מתבצע בתוך `torch.no_grad()`, ולאחריו מאפסים את הנגזרת לקראת האיטרציה הבאה.
