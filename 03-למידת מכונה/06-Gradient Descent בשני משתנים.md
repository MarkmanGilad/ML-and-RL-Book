...
נשתמש בפונקציית Peaks כדי לבחון חיפוש מינימום על משטח שתלוי בשני משתנים:
...
כדי לראות את המשטח שעליו יתבצע החיפוש, נחשב את גובהו בנקודות רבות. נגדיר את הפונקציה באמצעות NumPy. הפעולה `meshgrid` יוצרת רשת של זוגות ערכי x ו־y, שעליה נחשב את גובה המשטח.
...
כעת נפעיל את החיפוש ונעקוב אחר המסלול על המשטח. נבצע 200 איטרציות. בכל איטרציה נשמור את המיקום ברשימות, נחשב את הנגזרות, נעדכן את שני המשתנים ונאפס את הנגזרות:
