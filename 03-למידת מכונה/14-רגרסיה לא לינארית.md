...
כדי להזין לאימון אצוות של דוגמאות, נארגן כל קלט יחד עם התשובה שלו. נגדיר מחלקה השומרת את הקלט ואת התשובות כטנסורים. `__len__` מחזירה את מספר הדוגמאות, ו־`__getitem__` מחזירה זוג קלט ותשובה לפי אינדקס.
...
נפעיל את לולאת האימון על הרשת החדשה, כדי שתלמד את הקשר הלא־לינארי שבנתונים.
