...
גבול הסיווג מפריד בין האזורים שבהם המודל בוחר בכל קטגוריה, והוא עשוי להיות עקום. נבחן שלושה מבנים של נתונים בשתי קטגוריות: סהרונים, אשכולות וטבעות. לאחר מכן נאמן רשת על הסהרונים ונציג כיצד היא מסווגת נקודות נוספות במישור.
...
אחרי שהכרנו את שלוש צורות הנתונים, נחזור לסהרונים ונכין אותם לאימון הרשת.
...
כדי לראות כיצד הרשת מחלקת את המישור לקטגוריות, נבדוק גם נקודות שלא נכללו באימון. נגריל נקודות במלבן שסביב הנתונים:
