...
<figure>
<img src="../assets/training-loop.svg" alt="מחזור האימון: קלט נכנס לרשת, הפלט מושווה לתשובה הרצויה, והטעות משמשת לעדכון המשקלים." style="width:760px;max-width:100%;height:auto;">
<figcaption>מחזור האימון: הרשת מפיקה פלט, משווים אותו לתשובה הרצויה, ומעדכנים את המשקלים כדי להקטין את הטעות.</figcaption>
</figure>
