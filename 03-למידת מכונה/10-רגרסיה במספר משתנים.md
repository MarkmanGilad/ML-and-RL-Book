...
נכין את שטח הדירה ואת הקומה כשני נתוני קלט, לצד המחיר שאותו נרצה לחזות.
...
בנרמול של כמה תכונות נבחין בין ערכים של הטנסור כולו לערכים של כל עמודה בנפרד. תחילה נמצא את הערך הקטן ביותר בכל הטנסור:
...
הפרמטרים שנלמדו קובעים כיצד השטח והקומה משתתפים בתחזית. נציג את שני המשקלים ואת ההטיה:
