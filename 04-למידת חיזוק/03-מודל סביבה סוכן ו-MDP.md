...
<div class="formula" dir="ltr">V<sub>π</sub>(s) = r<sub>t+1</sub> + r<sub>t+2</sub> + … + r<sub>T</sub> = G<sub>t</sub></div>
...
<div class="formula" dir="ltr">Q<sub>π</sub>(s,a) = r<sub>t+1</sub> + r<sub>t+2</sub> + … + r<sub>T</sub> = G<sub>t</sub> &nbsp; (a<sub>t</sub> = a)</div>
