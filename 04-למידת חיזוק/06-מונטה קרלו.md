...
<figure>
<img src="../assets/slides/ff855051b3/slide03-x-move.png" alt="לוח ריק בתור X, חץ, ולוח עם X במשבצת העליונה האמצעית בתור O" style="width:60%;max-width:100%;height:auto;">
<figcaption>הלוח הריק (משמאל) והלוח מיד אחרי הפעולה של X (מימין). זה עדיין אינו המצב הבא של X: היריב טרם שיחק.</figcaption>
</figure>

<figure>
<img src="../assets/slides/ff855051b3/slide03-opponent-replies.png" alt="שלושה לוחות אפשריים אחרי תגובת O: בפינה השמאלית העליונה, במרכז, ובפינה הימנית התחתונה" style="width:75%;max-width:100%;height:auto;">
...
<figure>
<img src="../assets/slides/ff855051b3/image16.png" alt="עץ משחק עם מסלול אחד מודגש באדום מהשורש עד מצב סופי" style="width:75%;max-width:100%;height:auto;">
...
<figure>
<img src="../assets/slides/ff855051b3/image25.png" alt="טבלת Q: שורה לכל מצב לוח, עמודה לכל משבצת, N/A במשבצות תפוסות" style="width:75%;max-width:100%;height:auto;">
