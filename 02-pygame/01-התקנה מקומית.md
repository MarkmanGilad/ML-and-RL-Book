...
יוצרים תיקייה בשם `pygame_lessons`. ב־VS Code בוחרים **File → Open Folder** ופותחים אותה. יוצרים קובץ בשם `check_pygame.py`. לא משתמשים בשם `pygame.py`, כדי שלא להסתיר בטעות את הספרייה שנרצה לייבא.
...
בוחרים **Terminal → New Terminal**. בתחתית העורך ייפתח הטרמינל — המקום שבו מקלידים פקודות התקנה והרצה. הוא שונה מקובץ הקוד שמעליו.
