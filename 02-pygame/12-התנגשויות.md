...
<figure>
<img src="../assets/pygame/collisions-window.png" alt="חלון Pygame בשם Collisions ובו שני כוכבים חופפים על רקע בהיר, סימן שזוהתה התנגשות." width="640">
<figcaption>התוכנית בהרצה: שני הכוכבים מתחילים חופפים, ולכן הרקע בהיר. הזיזו את הכוכב בחצים כדי לראות מתי הרקע חוזר לכהה.</figcaption>
</figure>
